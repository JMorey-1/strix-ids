 ...
 *
 * Each record tracks how often an IP has produced WATCH or ALERT events,
 * builds a suspicion score over time and moves the IP through the mitigation
 * states used by Strix.
 */
@Entity
