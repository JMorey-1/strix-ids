 ...
 *
 * Most of the dashboard data now comes from live IDS event and mitigation
 * endpoints. This controller only handles the general status summary used
 * by the top dashboard cards.
 */
@RestController
