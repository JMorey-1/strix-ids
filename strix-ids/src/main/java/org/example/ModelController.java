 ...
 *
 * <p>This controller is mainly used by the traffic generator and during demos. It lets me switch
 * the IDS into training collection mode, train the model from the collected samples and check the
 * current model state.
 */
@RestController
...
public class ModelController {
  ...
  public ModelController(
      AnomalyDetectionService anomalyDetectionService, MitigationService mitigationService) {
