 ...
 *
 * The IDS uses these events as its raw input. Each event records where the request
 * came from, what endpoint was accessed, when it happened and what response status
