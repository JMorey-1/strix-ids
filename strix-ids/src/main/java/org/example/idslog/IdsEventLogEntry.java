 ...
 *
 * <p>These entries are used both for terminal output and the dashboard console. Each entry stores
 * the event level, IP address, anomaly score, message and feature vector that produced the
 * decision.
 */
