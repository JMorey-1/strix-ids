 ...
 *
 * <p>This profile sends requests across a wide range of public, protected and non-existent routes.
 * The aim is to create behaviour that looks different from normal browsing, especially through high
 * endpoint variety and error responses.
 */
