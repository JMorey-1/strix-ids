 ...
 *
 * <p>This profile repeatedly tries to access admin endpoints without a valid token. It is meant to
 * create suspicious admin-focused behaviour for Strix to detect through admin route usage and
 * unauthorised or forbidden responses.
 */
public class AdminProbeProfile implements TrafficProfile {

  private static final String[] ADMIN_ENDPOINTS = {
    "/admin", "/admin/users", "/admin/settings", "/admin/reports", "/admin/audit"
  };
