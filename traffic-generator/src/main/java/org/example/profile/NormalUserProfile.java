 ...
 *
 * This profile is used during both warm-up and detection. During warm-up it gives
 * Strix examples of ordinary browsing behaviour, then during detection it helps
 * prove that normal users are not being flagged as attacks.
 */
