 ...
 *
 * <p>This class keeps the request-sending logic in one place. The generator can then focus on
 * behaviour patterns, while this client handles GET requests, POST requests, fake IP headers and
 * signalling the IDS.
 */
public class TrafficClient {
  ...
  public void signalIds(String path) throws IOException, InterruptedException {
    HttpRequest request = HttpRequest.newBuilder().uri(URI.create(idsBaseUrl + path)).GET().build();
