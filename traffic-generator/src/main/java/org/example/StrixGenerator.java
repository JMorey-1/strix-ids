 ...
 *
 * <p>This class wires together the traffic client, the different behaviour profiles and the
 * scenario runner. The generator is used to create normal traffic first, then suspicious traffic
 * for the IDS to detect.
 */
public class StrixGenerator {

  private static final String BASE_URL =
      getEnvOrDefault("STRIX_TARGET_BASE_URL", "http://localhost:8080");

  private static final String IDS_BASE_URL =
      getEnvOrDefault("STRIX_IDS_BASE_URL", "http://localhost:8081");
  ...
  public static void main(String[] args) throws Exception {
    ...
    GeneratorScenarioRunner scenarioRunner =
