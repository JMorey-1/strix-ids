 ...
 *
 * These routes give the traffic generator user-specific pages to access.
 * They require a basic hardcoded token so Strix can observe unauthorised
 * and forbidden responses when suspicious clients try to access user areas.
 */
@RestController
@RequestMapping("/user")
