 ...
 *
 * This controller is intentionally basic. It gives the traffic generator a login
 * route to use during normal browsing and gives Strix a way to observe failed
 * login attempts during brute-force simulations.
 */
@RestController
@RequestMapping("/auth")
