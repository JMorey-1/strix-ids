 ...
 *
 * These routes are useful for generating admin probing behaviour during testing.
 * They require a basic hardcoded token so Strix can observe unauthorised and
 * forbidden responses when suspicious clients try to access admin areas.
 */
@RestController
